...
import "./Corelation.css"; // Import CSS file
...
const App = () => {
  ...
  const [correlations, setCorrelations] = useState({}); // State to store correlation values
  ...
  const fetchPrecipitation = async (city) => {
    ...
    try {
      ...
      const averagePrecipitation = precipitationData.reduce((sum, val) => sum + val, 0) / precipitationData.length;
  ...
  return (
    <div className="App">
        ...
        <div className="preferences">
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) => setPreferences({ ...preferences, humidity: e.target.value })}
            >
              <option value="low">Low</option>
              <option value="high">High</option>
            </select>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) => setPreferences({ ...preferences, windSpeed: e.target.value })}
            >
              <option value="low">Low</option>
              <option value="high">High</option>
            </select>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) => setPreferences({ ...preferences, precipitation: e.target.value })}
            >
              <option value="low">Low</option>
              <option value="high">High</option>
            </select>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) => setPreferences({ ...preferences, airQuality: e.target.value })}
            >
              <option value="low">Low</option>
              <option value="high">High</option>
            </select>
      ...
      {betterCity && <p className="result">The better city based on your preferences is: {betterCity}</p>}
